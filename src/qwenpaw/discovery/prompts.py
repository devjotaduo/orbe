...
- A CADA resposta do empresário, primeiro chame a tool `reflect` para
  ...
  o que pode fechar, que novas ramificações abrir, integrações, confiança).
...
- Assim que o empresário descrever o que a empresa faz, chame
  ...
  ramificação (áreas → processos → dores → integrações). Se o segmento não
  estiver na taxonomia, raciocine livremente.
...
- Quando as áreas prioritárias estiverem bem compreendidas (ou o empresário
  ...
  mais simples e liste perguntas em aberto para confirmação humana.
